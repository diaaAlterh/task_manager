...
mixin _$TodosState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(TodosListModel? items) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(TodosListModel? items)? loaded,
...
abstract class Initial implements TodosState {
...
class _$LoadedImpl implements Loaded {
  ...
  @override
  final TodosListModel? items;

  @override
  String toString() {
    return 'TodosState.loaded(items: $items)';
  }
...
abstract class Loaded implements TodosState {
  const factory Loaded(final TodosListModel? items) = _$LoadedImpl;

  TodosListModel? get items;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
...
abstract class Error implements TodosState {
