...
class _TodosServices implements TodosServices {
  _TodosServices(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<TodosListModel> getTodosList({
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<TodosListModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TodosListModel.fromJson(_result.data!);
    return value;
  }
